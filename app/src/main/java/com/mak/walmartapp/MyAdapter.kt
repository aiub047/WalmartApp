...
class MyAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.rlItem.setOnClickListener {
            val itemDescIntent = Intent(context, ItemDesc::class.java)

            val ivItemImageBitmap = holder.ivItemImage.drawable.toBitmap()
            val ivItemLogoBitmap = holder.ivLogo.drawable.toBitmap()

            itemDescIntent.putExtra("itemName", holder.tvItemName.text)
            itemDescIntent.putExtra("itemModel", holder.tvItemModel.text)
            itemDescIntent.putExtra("itemPrice", holder.tvPrice.text)
            ...
            context.startActivity(itemDescIntent)
        }
